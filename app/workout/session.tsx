...
function CheckIcon() {
  return (
    <Svg width={18} height={18} viewBox="0 0 24 24" fill="none" stroke={C.accentInk} strokeWidth={2.4} strokeLinecap="round" strokeLinejoin="round">
...
function AddIcon() {
  return (
    <Svg width={17} height={17} viewBox="0 0 24 24" fill="none" stroke={C.text} strokeWidth={2.2} strokeLinecap="round">
...
function CheckSmallIcon() {
  return (
    <Svg width={17} height={17} viewBox="0 0 24 24" fill="none" stroke={C.accentInk} strokeWidth={3} strokeLinecap="round" strokeLinejoin="round">
      <Path d="M5 12.5 10 17l9-10" />
    </Svg>
  );
}
    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      <View style={styles.body}>
        ...
        <Animated.View style={[styles.head, s(headAnim)]}>
          ...
          <IconButton onPress={() => router.push('/workout/detail')}>
            <InfoIcon />
          </IconButton>
        </Animated.View>
        ...
        <Animated.View style={[styles.video, s(d2)]}>
          ...
          <View style={styles.videoTime}>
            <Text style={styles.videoTimeText}>0:42 / 2:10</Text>
          </View>
        ...
        <Animated.View style={[styles.setsRow, s(d3)]}>
          {SETS.map((set) => (
            <View
              ...
              style={[
                styles.setDot,
                set.done && styles.setDotDone,
                set.cur && styles.setDotCur,
              ]}
            >
              <Text style={[styles.setNum, set.done && styles.setNumDone]}>
                {set.n}
              </Text>
              <Text style={[styles.setVal, set.done && styles.setValDone]}>
                {set.wt}×{set.reps}
              </Text>
            </View>
          ))}
        ...
        <Animated.View style={[styles.actionRow, s(d4)]}>
          ...
          <TouchableOpacity activeOpacity={0.85} style={styles.logBtn}>
            <CheckIcon />
            <Text style={styles.logText}>Log set 3</Text>
          </TouchableOpacity>
        </Animated.View>
      </View>
