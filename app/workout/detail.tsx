      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Animated.View style={[styles.video, s(d1)]}>
          <View style={styles.videoChip}>
            <Text style={styles.videoChipText}>Demo</Text>
          </View>
          <TouchableOpacity style={styles.playBtn} activeOpacity={0.8}>
            <PlayIcon />
          </TouchableOpacity>
          <View style={styles.videoTime}>
            <Text style={styles.videoTimeText}>0:00 / 2:10</Text>
          </View>
        ...
        <Animated.View style={[styles.statsRow, s(d2)]}>
          ...
          <View style={styles.statTile}>
            <Text style={styles.statVal}>90s</Text>
...
const styles = StyleSheet.create({
  ...
  statsRow: { flexDirection: 'row', gap: 10, marginBottom: 16, textAlign: 'center' as any },
