...
function BoltIcon() {
  return (
    <Svg width={22} height={22} viewBox="0 0 24 24" fill={C.accentInk}>
...
function CheckIcon() {
  return (
    <Svg width={11} height={11} viewBox="0 0 24 24" fill="none" stroke={C.accentInk} strokeWidth={3} strokeLinecap="round" strokeLinejoin="round">
      <Path d="M5 12.5 10 17l9-10" />
    </Svg>
  );
}

function useCountUp(target: number, delay: number = 600) {
