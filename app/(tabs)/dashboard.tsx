...
function FireIcon() {
  return (
    <Svg width={15} height={15} viewBox="0 0 24 24" fill={C.text}>
      <Path d="M12 3c1 3 4 4.5 4 8a4 4 0 0 1-8 0c0-1.5.8-2.6 1.5-3.5C10 9 9.2 5.5 12 3Z" />
    </Svg>
  );
}
...
function useCountUp(target: number, delay: number = 300) {
...
export default function DashboardScreen() {
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.body}>
          ...
          <Animated.View style={[styles.progressBlock, s(d1)]}>
            ...
            <View style={styles.aheadBadge}>
              <Svg width={13} height={13} viewBox="0 0 24 24" fill={C.accent}>
                <Path d="M13 2 4 14h7l-1 8 9-12h-7l1-8Z" />
              </Svg>
      ...
      {/* Tab bar gradient backdrop */}
      <LinearGradient
        colors={['transparent', C.screen]}
